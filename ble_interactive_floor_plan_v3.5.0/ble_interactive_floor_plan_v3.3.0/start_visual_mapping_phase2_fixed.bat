...
if exist "ble_visual_mapping_phase2_main.py" (
    echo Found Python file, starting application...
    python ble_visual_mapping_phase2_main.py
) else (
    echo ERROR: ble_visual_mapping_phase2_main.py not found in current directory!
    echo Current directory: %CD%
